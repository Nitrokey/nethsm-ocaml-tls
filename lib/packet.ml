...
type signature_alg =
  ...
  | ECDSA_BRAINPOOLP256R1_SHA256 [@id 0x081A] (* RFC 8734 *)
  | ECDSA_BRAINPOOLP384R1_SHA384 [@id 0x081B] (* RFC 8734 *)
  | ECDSA_BRAINPOOLP512R1_SHA512 [@id 0x081C] (* RFC 8734 *)
...
let signature_alg_to_int = function
  ...
  | ECDSA_BRAINPOOLP256R1_SHA256 -> 0x081A (* RFC 8734 *)
  | ECDSA_BRAINPOOLP384R1_SHA384 -> 0x081B (* RFC 8734 *)
  | ECDSA_BRAINPOOLP512R1_SHA512 -> 0x081C (* RFC 8734 *)
...
and int_to_signature_alg = function
  ...
  | 0x081A -> Some ECDSA_BRAINPOOLP256R1_SHA256
  | 0x081B -> Some ECDSA_BRAINPOOLP384R1_SHA384
  | 0x081C -> Some ECDSA_BRAINPOOLP512R1_SHA512
...
let to_signature_alg = function
  ...
  | `ECDSA_BRAINPOOLP256R1_SHA256 -> ECDSA_BRAINPOOLP256R1_SHA256
  | `ECDSA_BRAINPOOLP384R1_SHA384 -> ECDSA_BRAINPOOLP384R1_SHA384
  | `ECDSA_BRAINPOOLP512R1_SHA512 -> ECDSA_BRAINPOOLP512R1_SHA512
  | `ED25519 -> ED25519
...
let of_signature_alg = function
  ...
  | ECDSA_BRAINPOOLP256R1_SHA256 -> Some `ECDSA_BRAINPOOLP256R1_SHA256
  | ECDSA_BRAINPOOLP384R1_SHA384 -> Some `ECDSA_BRAINPOOLP384R1_SHA384
  | ECDSA_BRAINPOOLP512R1_SHA512 -> Some `ECDSA_BRAINPOOLP512R1_SHA512
...
let named_group_to_int = function
  ...
  | BRAINPOOLP384R1 -> 27 (*RFC7027*)
  | BRAINPOOLP512R1 -> 28 (*RFC7027*)
  (* OBSOLETE_RESERVED 0x001A - 0x001C *)
  | X25519          -> 29 (*RFC8446*)
  | X448            -> 30 (*RFC8446*)
...
and int_to_named_group = function
  ...
  | 24 -> Some SECP384R1
  | 25 -> Some SECP521R1
  | 26 -> Some BRAINPOOLP256R1
  | 27 -> Some BRAINPOOLP384R1
  | 28 -> Some BRAINPOOLP512R1
  | 29 -> Some X25519
  | 30 -> Some X448
  | 256 -> Some FFDHE2048
  | 257 -> Some FFDHE3072
